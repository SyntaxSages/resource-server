...
* The original package name 'com.syntaxsages.resource-server' is invalid and this project uses 'com.syntaxsages.resource_server' instead.
...
```
$ docker run --rm -p 8080:8080 resource-server:0.0.1-SNAPSHOT
```
